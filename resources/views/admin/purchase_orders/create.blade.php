...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header border-bottom py-3">
            <h5 class="mb-0 fw-bold text-primary"><i class="bx bx-cart me-2"></i>New Purchase Order</h5>
        </div>
            ...
            <form method="POST" action="{{ route('admin.purchase-orders.store') }}" id="poForm">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="2" placeholder="Optional purchase order notes...">{{ old('notes') }}</textarea>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4 fw-bold"><i class="bx bx-check me-1"></i> Create Order</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" style="max-width: 1100px;">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header py-3" style="background: linear-gradient(135deg, #1e293b, #0f172a) !important;">
                <h5 class="modal-title fw-bold" style="color: #ffffff !important;"><i class="bx bx-package me-2 fs-4" style="color: #818cf8 !important;"></i>Select Spare Parts for Purchase</h5>
