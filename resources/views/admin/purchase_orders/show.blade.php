    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <div>
                ...
                <a href="{{ route('admin.purchase-orders.pdf', $purchaseOrder) }}" class="btn btn-sm btn-danger me-1"><i class="bx bxs-file-pdf"></i> Download PDF</a>
        ...
        <div class="card-body">
            ...
            @include('admin.layouts.elements.payment_history_rollback', ['billType' => 'part_purchase', 'billId' => $purchaseOrder->id])
        </div>
    </div>
</div>
@endsection
