...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4 btn-print-group">
        ...
        <div>
            ...
            <a href="{{ route('admin.part-sales-invoices.pdf', $partSalesInvoice) }}" class="btn btn-danger me-1"><i class="bx bxs-file-pdf"></i> Download PDF</a>
                    ...
                    <div>
                        <table class="meta-table">
                            <tr>
                                ...
                                <td class="meta-value" style="text-align: left; padding-left: 10px;">{{ $partSalesInvoice->invoice_date->format('d/m/Y') }}{{ $partSalesInvoice->created_at ? ' ' . $partSalesInvoice->created_at->format('h:i A') : '' }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="right-panel">
                        <div class="summary-card">
                            <table class="summary-table">
                                ...
                                <tr>
                                    <td class="summary-label" style="font-weight: 600;">Current Invoice Total</td>
                                    <td class="summary-value" style="font-weight: 600;">₹ {{ number_format($partSalesInvoice->total_amount, 2) }}</td>
                                </tr>
                                <tr>
