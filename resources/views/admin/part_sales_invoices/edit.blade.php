        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.part-sales-invoices.update', $partSalesInvoice->id) }}" id="invoiceForm">
                ...
                <div class="row g-3 mb-4 bg-light p-3 rounded border border-light-subtle">
                    ...
                    <div id="customer_ledger_card" class="col-md-12 mb-3" style="display: none;">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="summary_total_bill" class="form-control bg-white fw-bold text-primary" readonly value="{{ number_format($partSalesInvoice->total_amount + $partSalesInvoice->previous_balance, 2, '.', '') }}">
                    </div>
                    <div class="col-md-3">
