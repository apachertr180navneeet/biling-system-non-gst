                ...
                <div class="summary-card">
                    <table class="summary-table">
                        ...
                        <tr class="summary-total-row">
                            ...
                            <td class="summary-value" style="font-weight: bold; font-size: 11px; text-align: right; color: #047857;">₹ {{ number_format($customerLedger->total_bill_amount ?? ($partSalesInvoice->total_amount + ($partSalesInvoice->previous_balance ?? 0)), 2) }}</td>
                        </tr>
                        <tr>
                            <td class="summary-label">Received Amount</td>
                            <td class="summary-value" style="color: #059669; font-weight: bold;">₹ {{ number_format($customerLedger->received_amount ?? $partSalesInvoice->received_amount ?? 0, 2) }}</td>
                        </tr>
                        <tr style="border-top: 1.5px solid #059669;">
                            ...
                            <td class="summary-value" style="font-weight: bold; font-size: 11px; color: #dc2626; padding-top: 3px;">₹ {{ number_format($customerLedger->outstanding_balance ?? $partSalesInvoice->current_balance ?? (($partSalesInvoice->previous_balance ?? 0) + $partSalesInvoice->balance), 2) }}</td>
                        </tr>
                    </table>
                </div>
            </td>
