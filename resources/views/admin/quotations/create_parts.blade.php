                ...
                <div class="table-responsive mb-4">
                    <table class="table table-bordered align-middle" id="partsTable">
                        <thead class="table-light">
                            <tr>
                                <th style="width: 40%;">Spare Part <span class="text-danger">*</span></th>
                        ...
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <table class="table table-sm table-borderless mb-0">
                                    <tr>
                                        <td>Total:</td>
                                        <td class="text-end fw-bold">₹<span id="summary_total">0.00</span></td>
                                    </tr>
                                    <tr>
                                        <td>Round Off:</td>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateTotals() {
        ...
        document.getElementById('summary_total').innerText = grand_sum.toFixed(2);
